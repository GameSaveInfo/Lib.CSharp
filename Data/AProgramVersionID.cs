...
namespace GameSaveInfo.Data {
    public abstract class AProgramVersionID : AProgramID, IComparable<AProgramVersionID>, IEquatable<AProgramVersionID> {
        [XmlAttribute("os")]
        ...
        public static int Compare(AProgramVersionID a, AProgramVersionID b, bool ignore_revision) {
        ...
        public int CompareTo(AProgramVersionID comparable) {
            return Compare(this, comparable, false);
        }

        public int CompareTo(AProgramVersionID comparable, bool ignore_revision) {
            return Compare(this, comparable, ignore_revision);
        }

        public static bool Equals(AProgramVersionID a, AProgramVersionID b) {
            return Compare(a, b, false) == 0;
        }

        public Boolean Equals(AProgramVersionID to_me) {
            return Equals(this, to_me as AProgramVersionID);
        }
