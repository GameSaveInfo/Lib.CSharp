...
namespace GameSaveInfo {
    public class Registry: AXmlDataSubEntry {
        ...
        public Registry(GameVersion version, string type): base(version) {
            this.Type = type;
        }

        public Registry(GameVersion version, XmlElement element) : base(version, element) { }
